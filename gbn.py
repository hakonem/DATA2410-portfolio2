...
#Function that sends and recives packages by using the GBN method
def GBN(packet, clientSocket, seq_num, ip, port, window, num_packets, skipSeq):
                ...
                while(seq_num <= num_packets + 1):
                    ...
                    try:
                        ...
                        #If received ACK is out of order
                            ...
                            #Resends all packages in the packets list
